...
public final class VideoEncode {
    ...
    public static void init() throws Exception {
        ...
        // 创建显示器
        try {
            display = SurfaceControl.createDisplay("carcontrol", Build.VERSION.SDK_INT < Build.VERSION_CODES.R || (Build.VERSION.SDK_INT == Build.VERSION_CODES.R && !"S".equals(Build.VERSION.CODENAME)));
        } catch (Exception e) {
    ...
    public static void startEncode() throws Exception {
        ...
        if (Options.mirrorMode == 1) {
            try {
                ...
                virtualDisplay = DisplayManager.createVirtualDisplay("carcontrol",
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
                ...
                display = SurfaceControl.createDisplay("carcontrol", false);
            }
