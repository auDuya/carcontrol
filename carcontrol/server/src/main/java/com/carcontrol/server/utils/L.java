...
public class L {
    ...
    public static void w(String message, Throwable throwable) {
        ...
        Log.w("carcontrol", message, throwable);
        flush(sb);
    }
    ...
    public static void e(String message, Throwable throwable) {
        ...
        Log.e("carcontrol", message, throwable);
        flush(sb);
    }
    ...
    public static void flush(StringBuilder sb) {
        ...
        try {
            if (fileOut == null) {
                fileOut = new PrintStream(new FileOutputStream("/data/local/tmp/carcontrol_log", false));
            }
            fileOut.println(sb);
    ...
    public static void postLog() {
        ...
        new Thread(() -> {
            try {
                File file = new File("/data/local/tmp/carcontrol_log");
                long lastLength = 0;
                while (true) {
